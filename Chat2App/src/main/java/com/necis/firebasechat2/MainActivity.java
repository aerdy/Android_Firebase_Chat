package com.necis.firebasechat2;
...
import com.necis.firebasechat2.adapter.Chat_Adapter;
import com.necis.firebasechat2.item.Chat_Item;
import com.necis.firebasechat2.service.NotificationChat;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conn = new Firebase("https://chatnecis.firebaseio.com/chat");
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Firebase fr = conn.child("bu_plex+" + datetime);
